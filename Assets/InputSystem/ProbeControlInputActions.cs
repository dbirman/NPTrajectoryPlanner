...
public partial class @ProbeControlInputActions: IInputActionCollection2, IDisposable
{
    ...
    private List<IProbeControlActions> m_ProbeControlActionsCallbackInterfaces = new List<IProbeControlActions>();
    ...
    public struct ProbeControlActions
    {
        ...
        public void AddCallbacks(IProbeControlActions instance)
        {
            if (instance == null || m_Wrapper.m_ProbeControlActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_ProbeControlActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IProbeControlActions instance)
        {
            @Slow.started -= instance.OnSlow;
            @Slow.performed -= instance.OnSlow;
            @Slow.canceled -= instance.OnSlow;
        ...
        public void RemoveCallbacks(IProbeControlActions instance)
        {
            if (m_Wrapper.m_ProbeControlActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IProbeControlActions instance)
        {
            foreach (var item in m_Wrapper.m_ProbeControlActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_ProbeControlActionsCallbackInterfaces.Clear();
